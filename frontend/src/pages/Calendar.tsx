...
export function Calendar() {
  ...
  const [statusFilters, setStatusFilters] = useState<Set<TaskStatus>>(
    new Set(Object.values(TaskStatus).filter(s => s !== TaskStatus.BLOCKED))
  );
              ...
              allDays.map((date, index) => {
                if (!date) {
                  return (
                    <Box
                      ...
                      border="1px"
                      borderColor={borderColor}
                      bg={useColorModeValue("gray.50", "dark.bg.primary")}
                    />
                  );
                }
                ...
                return (
                  <Box
                    ...
                    cursor="pointer"
                    _hover={{
                      bg: useColorModeValue("primary.50", "dark.bg.hover"),
                      borderColor: "primary.300",
                    }}
                    position="relative"
                    bg={
                      isCurrentDay
                        ? useColorModeValue("primary.50", "dark.bg.hover")
                        : cardBg
                    }
